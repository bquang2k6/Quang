...
const renderer = new THREE.WebGLRenderer({
  antialias: true, //  æ˜¯å¦æ‰§è¡Œæ—é”¯é½¿ă€‚é»˜è®¤å€¼ä¸ºfalseă€‚
});

// è®¾ç½®é¢œè‰²åå…¶é€æ˜åº¦
renderer.setClearColor(new THREE.Color("rgb(0,0,0)"));

// å°†è¾“ canvas ç„å¤§å°è°ƒæ•´ä¸º (width, height) å¹¶è€ƒè™‘è®¾å¤‡åƒç´ æ¯”ï¼Œä¸”å°†è§†å£ä» (0, 0) å¼€å§‹è°ƒæ•´åˆ°é€‚åˆå¤§å°
renderer.setSize(window.innerWidth, window.innerHeight);
document.body.appendChild(renderer.domElement);

// è¡¨ç¤ºå¯¹è±¡å±€éƒ¨ä½ç½®ç„ Vector3ă€‚é»˜è®¤å€¼ä¸º(0, 0, 0)ă€‚
...
new THREE.OBJLoader().load(
  ...
  (obj) => {
    ...
    // ç”¨äºåœ¨ç½‘æ ¼è¡¨é¢ä¸é‡‡æ ·å æƒéæœºç‚¹ç„å®ç”¨ç¨‹åºç±»ă€‚
